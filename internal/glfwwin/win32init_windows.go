...
func platformInit() error {
	...
	if err := _SystemParametersInfoW(_SPI_GETFOREGROUNDLOCKTIMEOUT, 0, unsafe.Pointer(&_glfw.win32.foregroundLockTimeout), 0); err != nil {
		return err
	}
	if err := _SystemParametersInfoW(_SPI_SETFOREGROUNDLOCKTIMEOUT, 0, nil, _SPIF_SENDCHANGE); err != nil {
		return err
	}
